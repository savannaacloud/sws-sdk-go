...
func (s *DatabaseService) ListInstances(ctx context.Context) ([]Database, error) {
	var out []Database
	if err := s.client.do(ctx, "GET", "/api/v1/database/instances", nil, &out); err != nil {
		return nil, err
	}
	return out, nil
}
...
func (s *DatabaseService) GetInstance(ctx context.Context, id string) (*Database, error) {
	var out Database
	if err := s.client.do(ctx, "GET", "/api/v1/database/instances/"+id, nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (s *DatabaseService) CreateInstance(ctx context.Context, opts *CreateDatabaseOpts) (*Database, error) {
	var out Database
	if err := s.client.do(ctx, "POST", "/api/v1/database/instances", opts, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (s *DatabaseService) DeleteInstance(ctx context.Context, id string) error {
	return s.client.do(ctx, "DELETE", "/api/v1/database/instances/"+id, nil, nil)
}
